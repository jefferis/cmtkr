...
cmtk_dof2mat_path <- function(reg, transpose = TRUE, matrix3x3 = FALSE) {
    .Call('_cmtkr_cmtk_dof2mat_path', PACKAGE = 'cmtkr', reg, transpose, matrix3x3)
}

cmtk_dof2mat_params <- function(params, transpose = TRUE, matrix3x3 = FALSE) {
